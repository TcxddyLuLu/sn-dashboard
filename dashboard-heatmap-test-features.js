/* Month picker and Excel export — heatmap test page */
...
function exportExcel() {
  ...
  if (daily) {
    ...
    XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(dailyWide), 'Daily Matrix (mock)');
  }
  ...
  const fname = `SN_Dashboard_HeatmapTest_${activeMonthKey.replace('-', '')}.xlsx`;
